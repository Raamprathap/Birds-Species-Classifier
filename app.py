...
model = load_model('Birds-Species-Classifier/model.h5')
...
def preprocess_image(img_path):
    img = image.load_img(img_path, target_size=(222, 222))
...
def upload():
    ...
    response_text = f"Species Name: {class_label} saved image: {image.filename}"
